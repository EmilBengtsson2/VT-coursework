;16:15
;Dato un vettore di interi vett1[]={4,6,8,9,10,12,16,3,24,15} copiare in un vettore vett2[] i numeri
;divisibili per 4 e in un vettore vett3[] quelli divisibili per 8
;calcolare successivamente i minimi scrivendoli in r29 e in r30,
		.data
vett1:	.word 4,6,8,9,10,12,16,3,5,15,24
...
while_scanvett1:
		...
		slt r5,r1,r3
		beq r5,r0,endwhile_scanvett1	;if(!(i<size)) goto endwhile_scanvett1
		ld r6,vett1(r1)			;r6=vett1[i]
		andi r7,r6,3
		bne r7,r0,testdivper8		;if(k%4!=0) goto testdivper8
		bne r2,r0,noprimodivper4		;if(i2!=0) goto noprimodivper4	
